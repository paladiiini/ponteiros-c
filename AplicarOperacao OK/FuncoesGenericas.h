...
void aplicarOperacao(void *dados[], int tam, void (*operacao)(void *)) {
    char op;
    operacao(&op);
...
void operacao(void *op) {
    ...
    if (*(char *)op == '+') {
        printf("\nOperacao selecionada: Somar\n");
    } else if (*(char *)op == '-') {
        printf("\nOperacao selecionada: Subtrair\n");
    } else if (*(char *)op == '*') {
        printf("\nOperacao selecionada: Multiplicar\n");
    } else if (*(char *)op == '/') {
        printf("\nOperacao selecionada: Dividir\n");
    } else {
